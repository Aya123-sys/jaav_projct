...
public class operating_company extends Company {
    private LocalDate TodayDate;
    private static final String statut = "operating";

    public operating_company(String id, String name, String category_list, String market, Double funding_total_usd,
    ...
    public void getStatus() {
        System.out.println("Operating Company: " + statut);
        
    }
    @Override
    public  int working_period(){
        return (int) ChronoUnit.YEARS.between(founded_at, TodayDate);
